...
#p1 = 'What are unit tests, integration tests, smoke tests, and regression tests? What are the differences between them and which tools can I use for each of them?'+\
...
#r1 = 'Integration testing: Integration testing is the integrate another element'+\
